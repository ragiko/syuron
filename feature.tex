...
実験は，NTCIR12 SpokenQuery\&Doc Formal-run の SQSCR SGS retrieval条件で行った．
実験条件を表\ref{t_feture}に示す．
特に指定しない限り，以下の実験ではクエリ・文書共に音声認識結果を利用した．
...
% TODO: クエリ尤度のときの式を定義
実験を行った結果を図5.またクエリ尤度モデルのみの時は、式??の $\nu = 0$ とする．
